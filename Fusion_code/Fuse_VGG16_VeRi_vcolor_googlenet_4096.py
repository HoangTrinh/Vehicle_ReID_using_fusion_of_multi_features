...
def triplet_train_on_VeRi(vgg16_train_file, vcolor_train_file, googleNet_train_file, out_name,
    ...
    model.fit([vgg16_feature, vcolor_feature, googleNet_feature], one_hot_labels, batch_size=2048, epochs=100,
...
def triplet_Fuse_extract(base_model_path, vgg16_feature_path, vcolor_feature_path, googleNet_feature_path, output_name,
                         ismodelfile=True):
    vgg16_feature = read_h5py_file(vgg16_feature_path)
    vcolor_feature = load_pickle_file(vcolor_feature_path, python=2)
...
if __name__ == '__main__':
    model = train_on_VeRi('../Features/name_train_VGG16_VeRi.h5', '../Features/vcolor_train.pkl',
                          '../Models/Fusion/model_double_VGG16_VeRi_vcolor_4096.h5', xml_name_file_path='../Data/VeRi/train_label.xml')

    Fuse_extract(model, '../Features/name_query_VGG16_VeRi.h5', '../Features/vcolor_query.pkl',
                 '../Features/query_double_VGG16_VeRi_vcolor_4096.h5',
                 ismodelfile=False)
    Fuse_extract(model, '../Features/name_test_VGG16_VeRi.h5', '../Features/vcolor_test.pkl',
                 '../Features/test_double_VGG16_VeRi_vcolor_4096.h5',
                 ismodelfile=False)

    compute_distance_file('../Features/test_double_VGG16_VeRi_vcolor_4096.h5',
                          '../Features/query_double_VGG16_VeRi_vcolor_4096.h5',
                          '../Evaluation/Distance_files/dist_double_VGG16_VeRi_vcolor_4096.txt')
    K.clear_session()

    triple_model = triplet_train_on_VeRi('../Features/name_train_VGG16_VeRi.h5', '../Features/vcolor_train.pkl',
                                         '../Features/googlenet_train.pkl',
                                         '../Models/Fusion/model_triple_VGG16_VeRi_vcolor_googlenet_4096.h5',
                                         xml_name_file_path='../Data/VeRi/train_label.xml')

    triplet_Fuse_extract(triple_model, '../Features/name_query_VGG16_VeRi.h5', '../Features/vcolor_query.pkl',
                         '../Features/googlenet_query.pkl',
                         '../Features/query_triple_VGG16_VeRi_vcolor_googlenet_4096.h5', ismodelfile=False)
    triplet_Fuse_extract(triple_model, '../Features/name_test_VGG16_VeRi.h5', '../Features/vcolor_test.pkl',
                         '../Features/googlenet_test.pkl',
                         '../Features/test_triple_VGG16_VeRi_vcolor_googlenet_4096.h5', ismodelfile=False)

    compute_distance_file('../Features/test_triple_VGG16_VeRi_vcolor_googlenet_4096.h5',
                          '../Features/query_triple_VGG16_VeRi_vcolor_googlenet_4096.h5',
                          '../Evaluation/Distance_files/dist_triple_VGG16_VeRi_vcolor_googlenet_4096.txt')