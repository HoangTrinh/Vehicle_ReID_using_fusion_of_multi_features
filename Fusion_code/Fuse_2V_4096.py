...
def train_on_VeRi(vgg16_train_file_1, vgg16_train_file_2, out_name, xml_name_file_path='train_label.xml'):
    ...
    model.fit([vgg16_feature, vcolor_feature], one_hot_labels, batch_size=4096, epochs=200)
...
if __name__ == '__main__':
    model = train_on_VeRi('../Features/name_train_VGG16_VeRi.h5', '../Features/name_train_VGG16_CompCars.h5',
                          '../Models/Fusion/model_double_2V_4096.h5',
                          xml_name_file_path='../Data/VeRi/train_label.xml')

    Fuse_extract(model, '../Features/name_query_VGG16_VeRi.h5', '../Features/name_query_VGG16_CompCars.h5',
                 '../Features/query_double_2V_4096.h5',
                 ismodelfile=False)
    Fuse_extract(model, '../Features/name_test_VGG16_VeRi.h5', '../Features/name_test_VGG16_CompCars.h5',
                 '../Features/test_double_2V_4096.h5',
                 ismodelfile=False)

    compute_distance_file('../Features/test_double_2V_4096.h5', '../Features/query_double_2V_4096.h5',
                          '../Evaluation/Distance_files/dist_double_2V_4096.txt')
