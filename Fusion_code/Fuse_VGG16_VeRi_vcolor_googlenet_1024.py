...
if __name__ == '__main__':
    model = train_on_VeRi('../Features/name_train_VGG16_VeRi.h5', '../Features/vcolor_train.pkl', '../Models/Fusion/model_double_VGG16_VeRi_vcolor_1024.h5', xml_name_file_path = '../Data/VeRi/train_label.xml')

    Fuse_extract(model, '../Features/name_query_VGG16_VeRi.h5', '../Features/vcolor_query.pkl', '../Features/query_double_VGG16_VeRi_vcolor_1024.h5',
                 ismodelfile=False)
    Fuse_extract(model, '../Features/name_test_VGG16_VeRi.h5', '../Features/vcolor_test.pkl', '../Features/test_double_VGG16_VeRi_vcolor_1024.h5',
                 ismodelfile=False)

    compute_distance_file('../Features/test_double_VGG16_VeRi_vcolor_1024.h5', '../Features/query_double_VGG16_VeRi_vcolor_1024.h5',
                          '../Evaluation/Distance_files/dist_double_VGG16_VeRi_vcolor_1024.txt')
    K.clear_session()

    triple_model = triplet_train_on_VeRi('../Features/name_train_VGG16_VeRi.h5', '../Features/vcolor_train.pkl', '../Features/googlenet_train.pkl',
                                         '../Models/Fusion/model_triple_VGG16_VeRi_vcolor_googlenet_1024.h5', xml_name_file_path = '../Data/VeRi/train_label.xml')

    triplet_Fuse_extract(triple_model, '../Features/name_query_VGG16_VeRi.h5', '../Features/vcolor_query.pkl', '../Features/googlenet_query.pkl',
                         '../Features/query_triple_VGG16_VeRi_vcolor_googlenet_1024.h5', ismodelfile=False)
    triplet_Fuse_extract(triple_model, '../Features/name_test_VGG16_VeRi.h5', '../Features/vcolor_test.pkl', '../Features/googlenet_test.pkl',
                         '../Features/test_triple_VGG16_VeRi_vcolor_googlenet_1024.h5', ismodelfile=False)

    compute_distance_file('../Features/test_triple_VGG16_VeRi_vcolor_googlenet_1024.h5',
                          '../Features/query_triple_VGG16_VeRi_vcolor_googlenet_1024.h5',
                          '../Evaluation/Distance_files/dist_triple_VGG16_VeRi_vcolor_googlenet_1024.txt')