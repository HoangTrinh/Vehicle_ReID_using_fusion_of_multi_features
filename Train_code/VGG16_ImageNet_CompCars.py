...
if __name__ == '__main__':
    ...
    VGG16_pool5_extract(C_model, '../Data/VeRi/name_query.txt', '../Data/VeRi/image_query', '../Features/name_query_VGG16_ImageNet_CompCars.h5', ismodelfile=False)
    VGG16_pool5_extract(C_model, '../Data/VeRi/name_test.txt', '../Data/VeRi/image_test', '../Features/name_test_VGG16_ImageNet_CompCars.h5', ismodelfile=False)
    compute_distance_file('../Features/name_test_VGG16_ImageNet_CompCars.h5', '../Features/name_query_VGG16_ImageNet_CompCars.h5',
                          '../Evaluation/Distance_files/dist_VGG16_ImageNet_CompCars.txt')
