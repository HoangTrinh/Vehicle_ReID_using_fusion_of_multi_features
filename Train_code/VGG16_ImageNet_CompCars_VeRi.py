...
if __name__ == '__main__':
    ...
    C_model = train_on_ComCars(base_model, fix_layer=7,image_folder='../Data/CompCars/image', out_name='../Models/VGG16/model_VGG16_ImageNet_CompCars.h5',ismodelfile=False)
    V_model = train_on_VeRi(C_model, fix_layer=11, image_folder='../Data/VeRi/image_train', xml_file='../Data/VeRi/train_label.xml',
                             out_name='../Models/VGG16/model_VGG16_ImageNet_CompCars_VeRi.h5',
                             ismodelfile=False)
    VGG16_pool5_extract(V_model, '../Data/VeRi/name_query.txt', '../Data/VeRi/image_query', '../Features/name_query_VGG16_ImageNet_CompCars_VeRi.h5', ismodelfile=False)
    VGG16_pool5_extract(V_model, '../Data/VeRi/name_test.txt', '../Data/VeRi/image_test', '../Features/name_test_VGG16_ImageNet_CompCars_VeRi.h5', ismodelfile=False)
    compute_distance_file('../Features/name_test_VGG16_ImageNet_CompCars_VeRi.h5', '../Features/name_query_VGG16_ImageNet_CompCars_VeRi.h5',
                          '../Evaluation/Distance_files/dist_VGG16_ImageNet_CompCars_VeRi.txt')
