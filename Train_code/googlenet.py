...
if __name__ == '__main__':
    ...
    extract_vcolor("../Data/VeRi/name_train.txt", "../Models/GoogleNet/deploy.prototxt", "../Models/GoogleNet/googlenet_finetune_web_car_iter_10000.caffemodel", "pool5",
                   '../Features/googlenet_train.pkl')

    extract_vcolor("../Data/VeRi/name_test.txt", "../Models/GoogleNet/deploy.prototxt", "../Models/GoogleNet/googlenet_finetune_web_car_iter_10000.caffemodel", "pool5",
                   '../Features/googlenet_test.pkl')

    extract_vcolor("../Data/VeRi/name_query.txt", "../Models/GoogleNet/deploy.prototxt", "../Models/GoogleNet/googlenet_finetune_web_car_iter_10000.caffemodel", "pool5",
                   '../Features/googlenet_query.pkl')
    compute_distance_file('../Features/googlenet_test.pkl', '../Features/googlenet_query.pkl', '../Evaluation/Distance_files/dist_googlenet.txt')